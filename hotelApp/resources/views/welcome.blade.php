...
<body>
        <!-- PAGE CONTAINER-->
        <div class="page-container" style="padding-left: 0px; top: 0px">
            <!-- HEADER DESKTOP-->
            ...
            <div class="main-content">
                <div id="welcome-content" class="col-lg-12" style="text-align: center">
                       <h1 style="color:white"> Bookings Admin </h1>
                </div>
                <div class="my-5" style="text-align: center">
                    <a href="/bookings">
                        <button type="button" class="btn btn-outline-primary">
                            <i class="fa fa-lightbulb-o"></i>&nbsp; Manage Bookings
                        </button>
                    </a>
                </div>
            </div>
