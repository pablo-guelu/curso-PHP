<template>
    ...
    <div class="col-md-9 col-lg-7 col-xl-7 mx-auto">
        <form action="" method="post" class="my-4" @submit.prevent="login()">
                    <!-- Email input -->
            <div class="form-outline mb-4">
              <input type="email" id="form1Example13" class="form-control form-control-lg" v-model="user.email">
            ...
            <div class="d-flex justify-content-around align-items-center mb-4">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="form1Example3" v-model="user.remember" checked="">
